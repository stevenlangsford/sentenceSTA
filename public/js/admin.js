...
function quiz(){
	...
	"<span style='text-align:left'><p>"+
	 "<strong>For this study, which of these best describes a sentence that is <em>meaningful</em>?</strong></br>"+
...
function demographics(){
	...
	"<input type=\"radio\" name=\"gender\" id=\"other\" value=\"other\">&nbsp Other or decline to answer"+
	"</td></tr>"+
	"<tr><td>"+
