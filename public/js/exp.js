...
var conditions = shuffle([{question:"Is this sentence acceptable?",
			  ...
			  {question:"Is this sentence grammatical?",
			   optionlabels:["Definitely </br>not grammatical",
					 "Probably </br>not grammatical",
					 "Possibly </br>not grammatical",
					 "Possibly </br>grammatical",
					 "Probably </br>grammatical",
					 "Definitely </br>grammatical"],
			   myspacer:new spacerScreen("This block of questions asks you to judge if a sentence is grammatical or not. It doesn't matter if the sentence is ugly or even makes no sense: please answer 'Yes' if it is a valid construction in English or 'No' if it is not.")},
